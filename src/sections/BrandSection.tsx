  ...
  return (
    ...
    >
      ...
      <div ref={decorRef} className="absolute inset-0 pointer-events-none">
        <div className={`absolute ${isRTL ? 'right-[52vw]' : 'left-[52vw]'} top-[10vh] w-0 h-0 border-l-[5px] sm:border-l-[7px] border-l-transparent border-r-[5px] sm:border-r-[7px] border-r-transparent border-b-[10px] sm:border-b-[14px] border-b-yellow-500/60 hidden sm:block`} />
